...
- `.ai-dev/adapters/open-code-review.md` and `.opencodereview/rule.json` for optional open-code-review integration.
- `.ai-dev/mcp/` with Codex and Claude examples, without secrets.
- `.ai-dev/templates/` and `.ai-dev/runs/_task-template/`.
...
4. `.ai-dev/context/tool-bindings.md`
...
11. Run manual/agent review and open-code-review when configured.
12. Run `.ai-dev/harness/eval/harness-self-check.md`.
13. Update context capsule, test report, delivery report, wiki follow-up, and harness state.
14. Prepare Apifox, Codeup, Yuque, or DingTalk handoff notes when relevant.
